    ...
    <div className="border-b-2 bg-gradient-to-r from-gray-950 to-gray-900 fixed w-full top-0 border-slate-800 lg:hidden">
      <div className="flex flex-row ml-4 mr-4 mt-4 mb-2 lg:hidden">
        ...
        <div className="flex items-center justify-end">
          ...
          <AnimatePresence>
          {toggle && (
            <motion.div className="fixed top-0 left-0 w-5/6 sm:w-[33.5rem] h-full bg-black bg-gradient-to-tl from-gray-900 via-gray-950 z-50 flex flex-col gap-4 shadow-lg shadow-black-100/100 overflow-y-auto"
              key='mobile-menu'
              animate={{ x: [-600, 0, ]}}
              exit = {{ x: [0, -600]}}
              transition={{duration: 0.5, ease: "easeInOut"}}>
              
                <div className="fixed p-4 backdrop-blur-xl z-10 top-0 w-5/6 sm:w-[33.5rem]  ">
